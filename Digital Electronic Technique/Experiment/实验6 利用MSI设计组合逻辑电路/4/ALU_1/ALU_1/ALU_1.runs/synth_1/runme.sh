...
HD_PWD=D:/Vivado/Project/ALU_1/ALU_1.runs/synth_1
cd "$HD_PWD"
...
EAStep vivado -log ALU_1_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ALU_1_wrapper.tcl
