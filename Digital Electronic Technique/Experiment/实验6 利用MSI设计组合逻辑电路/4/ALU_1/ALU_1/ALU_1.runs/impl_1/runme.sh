...
HD_PWD=D:/Vivado/Project/ALU_1/ALU_1.runs/impl_1
cd "$HD_PWD"
...
EAStep vivado -log ALU_1_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source ALU_1_wrapper.tcl -notrace
