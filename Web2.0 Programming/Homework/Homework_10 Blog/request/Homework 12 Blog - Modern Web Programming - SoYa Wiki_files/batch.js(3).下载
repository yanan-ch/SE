...
Confluence.Templates.Comments.commentView = function(opt_data, opt_sb) {
  ...
  Confluence.Templates.Comments.userLogo({userInfo: opt_data.commenter, context: opt_data.context}, output);
  output.append('<p class="date" title="', soy.$$escapeHtml("just a moment ago"), '">', soy.$$escapeHtml("just a moment ago"), '</p><div class="comment-header"><h4 class="author">', (opt_data.commenter.userName == null) ? soy.$$escapeHtml("Anonymous") : '<a href="' + soy.$$escapeHtml(opt_data.context.contextPath) + '/display/' + soy.$$escapeUri(opt_data.commenter.userName) + '" class="url fn confluence-userlink" data-username="' + soy.$$escapeUri(opt_data.commenter.userName) + '">' + soy.$$escapeHtml(opt_data.commenter.displayName) + '</a>', '</h4></div><div class="comment-body"><div class="comment-content wiki-content">', opt_data.comment.html, '</div><div class="comment-actions">');
